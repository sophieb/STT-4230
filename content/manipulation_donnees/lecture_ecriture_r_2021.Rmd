...
```{r import_texte_2, eval = FALSE}
data_ex_txt <- read.table("data_ex.txt", header = TRUE)
str(data_ex_txt)
```
```{r, echo = FALSE}
# Je ne sais pas pourquoi ça n'affiche pas la même sortie que dans la console.
# Je fais donc la correction manuellement.
data_ex_txt_2 <- data.frame(de1 = de_1, de2 = de_2, lanceur = lanceur)
# de1 int au lieu de num
data_ex_txt_2$de1 <- as.integer(data_ex_txt_2$de1)
# Introduction de valeurs manquantes
data_ex_txt_2$de2[7] <- "."
data_ex_txt_2$lanceur[3] <- "."
# Affichage de la structure du date frame
str(data_ex_txt_2)
# Vérification dans la console
# identical(data_ex_txt, data_ex_txt_2)
```
...
```{r import_texte_3, eval = FALSE}
data_ex_txt <- read.table("data_ex.txt", header = TRUE, na.strings = ".")
str(data_ex_txt)
```
```{r, echo = FALSE}
data_ex_txt_3 <- data_ex
# de1 et d2 int au lieu de num
data_ex_txt_3$de1 <- as.integer(data_ex_txt_3$de1)
data_ex_txt_3$de2 <- as.integer(data_ex_txt_3$de2)
# Affichage de la structure du date frame
str(data_ex_txt_3)
# Vérification dans la console
# identical(data_ex_txt, data_ex_txt_3)
```
...
write(data_ex_json, "data_ex.json")
```
...
```{r, message = FALSE}
library(openxlsx)
write.xlsx(data_ex, file = "data_ex.xlsx")
```
