...
Il faut spécifier à la fonction l'objet, typiquement une matrice ou un data frame, dans lequel se trouvent les données à exporter (argument `x`), ainsi que le fichier dans lequel écrire les données (argument `file`).
