...
Le data frame obtenu dans le code précédent, nommé `boxoffice`, contient les recettes des films ayant générés le plus de revenus dans les cinémas américains, telles que présentées sur la page web http://pro.boxoffice.com/numbers/all_time le 25 janvier 2019. Ce data frame pourrait être amélioré en renommant ses colonnes.
