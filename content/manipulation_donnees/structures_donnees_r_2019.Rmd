...
*__-__ positions des éléments à exclure*;
...
```{r}
subset(dat, subset = c(TRUE, FALSE, TRUE, TRUE), select = - V3)
```
...
**Objet** R servant de structure de données  

$\qquad =$ CONTENANT

**Éléments** stockés dans cet objet  
