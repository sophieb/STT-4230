...
- nombre(s) positif(s) (entre 1 et la taille de la dimension concernée) : *positions des éléments à conserver*;
- nombre(s) négatif(s) (entre 1 et la taille de la dimension concernée) : *-1 $\times$ positions des éléments à éliminer*;
- chaîne(s) de caractères (possible seulement si les éléments sont nommés) : *noms des éléments à conserver*;
- vecteur de logiques (de même longueur que la dimension concernée) : `TRUE` *pour les éléments à conserver,* `FALSE` *pour ceux à éliminer*;
