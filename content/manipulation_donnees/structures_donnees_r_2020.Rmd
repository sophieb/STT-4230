...
- Opérateurs d'indiçage : 
    + `[` : extrait un ou plusieurs éléments, préserve la structure de l'objet, sauf si une simplification est possible et `drop = TRUE` (`TRUE` est la valeur par défaut de l'argument);
...
- entier(s) négatif(s) (entre 1 et la longueur de la dimension concernée) : *-1 $\times$ positions des éléments à éliminer*,
