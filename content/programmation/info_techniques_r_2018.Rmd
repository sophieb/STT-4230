...
- [`help(double)`](https://stat.ethz.ch/R-manual/R-devel/library/base/html/double.html)
...
Ceux qui utilisent `attach`, mentionné précédemment, le font souvent pour que le code soit moins long à taper. Si c'est votre cas, vous pourriez aimer utiliser les capacités de [complètement automatique](https://fr.wikipedia.org/wiki/Compl%C3%A8tement) (en anglais *completion* or *autocompletion*) d'un éditeur de code R. Cette fonctionnalité a justement pour but d'aider l'utilisateur à programmer plus rapidement, tout en diminuant les risques d'erreur de frappe.
