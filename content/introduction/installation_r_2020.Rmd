...
Cette fiche explique les étapes générales d'installation de [R](https://www.r-project.org/) et [RSutdio](https://www.rstudio.com/) pour tous les systèmes d'exploitation. Cependant, des explications plus détaillées sont fournies seulement pour le système d'exploitation Windows et un peu pour les systèmes Unix / Linux. Les utilisateurs Mac OS X / OS X / macOS ou Unix / Linux intressés à obtenir plus d'informations sont référés aux sites web suivants&nbsp;:
