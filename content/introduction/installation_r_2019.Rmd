...
Cette fiche explique les étapes générales d'installation de [R](https://www.r-project.org/) et [RSutdio](https://www.rstudio.com/) pour tous les systèmes d'exploitation, mais des explications plus détaillées sont fournies surtout le système d'exploitation Windows. Plus d'informations pour les utilisateurs Mac OS X / OS X / macOS ou Unix / Linux sont données dans les références suivantes&nbsp;:
...
Pour les utilisateurs de Windows, le [package `installr`](https://github.com/talgalili/installr/) propose des fonctions pour installer ou mettre à jour R, RStudio ou les Rtools simplement en lançant une commande dans la console R. https://github.com/talgalili/installr/
...
\definecolor{shadecolor}{gray}{0.2}\color{white}\begin{snugshade*}\begin{verbatim}
printf 'deb http://cran.rstudio.com/bin/linux/ubuntu trusty/\n'| sudo tee -a \
/etc/apt/sources.list
\end{verbatim}\end{snugshade*}\color{black}\definecolor{shadecolor}{RGB}{248,248,248}
...
\definecolor{shadecolor}{gray}{0.3}\color{white}\begin{snugshade*}\begin{verbatim}
...
<!--
Autre références qui m'ont été utiles
