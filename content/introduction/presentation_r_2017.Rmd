...
- Beaucoup de gens en parle sur internet.
- Savoir programmer en R est une compétence très souvent demandée pour des emplois en statistique/science des données.
...
Augmentation de questions relatives à R sur Stack Overflow
========================================================
...
\footnotesize
Source : [https://insights.stackoverflow.com/trends](https://insights.stackoverflow.com/trends?utm_source=so-owned&utm_medium=blog&utm_campaign=trends&utm_content=blog-link&tags=java%2Cc%2Cc%2B%2B%2Cpython%2Cc%23%2Cvb.net%2Cjavascript%2Cassembly%2Cphp%2Cperl%2Cruby%2Cvb%2Cswift%2Cr%2Cobjective-c)
\normalsize


Tendance dans les mentions de R dans les offres d'emplois en statistique/science des données sur Indeed.com
========================================================
...
\footnotesize
Source : [https://www.indeed.com/jobtrends](https://www.indeed.com/jobtrends/q-Excel-data-statistics-q-R-data-statistics-q-SAS-data-statistics-q-Python-data-statistics-q-SPSS-data-statistics-q-Tableau-data-statistics.html)
\normalsize
...
- langage interprété : **R peut être lent** pour réaliser certains calculs;
