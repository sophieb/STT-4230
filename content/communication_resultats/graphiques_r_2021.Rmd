...
Un titre et des noms d'axes ont été produits par défaut par le fonction `hist`, mais il faudrait les adapter pour une publication en français.
...
- packages [`maps`](https://CRAN.R-project.org/package=maps)
