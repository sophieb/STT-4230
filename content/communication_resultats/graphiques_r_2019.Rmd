...
```{r echo = FALSE}
knitr::opts_chunk$set(fig.align = 'center', fig.show = 'hold', out.width = "100%") # out.width = "70%" pour PDF, 100% pour HTML
...
# Le graphique produit n'apparaît pas dans le fichier PDF, car il est affiché dans
# une fenêtre graphique interactive qui ne peut pas être intégrée à un PDF. 
```
```{r, echo = FALSE}
rglwidget()
```
