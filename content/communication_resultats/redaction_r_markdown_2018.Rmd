...
Notons que plusieurs autres fonctions permettent de formater un data frame R pour créer un tableau dans un document rédigé en R Markdown. Quelques-unes sont mentionnées sur la page web suivante : http://rmarkdown.rstudio.com/lesson-7.html. La mise en forme du tableau obtenu diffère légèrement d'une fonction à l'autre.
