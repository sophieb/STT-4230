...
```{r, fig.align='center'} 
boxplot(cnt ~ mnth, data = bike2011)
# ajout du titre et identifications des 2 axes 
mtext("Évolution mensuelle du nombre de locations par jour en 2011 lors de jours de travail", side = 3, cex = 0.95, font = 2, line = 1.5)
...
ggplot(bike,aes(x = as.factor(mnth),  y=cnt, fill= bike$travail)) + 
  geom_boxplot() + 
