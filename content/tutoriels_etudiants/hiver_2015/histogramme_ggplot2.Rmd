...
```
La variable `weathersit` contient les climats. Nous allons la renommer `Température`; elle est de type entier et prend les valeurs; 1: clair, partiellement nuageux, 2: brume + nuageux, brume + Peu de nuages,
