...
```
```{r 1er tableau widgetframe, echo = FALSE, eval = FALSE}
...
```
```{r no rownames widgetframe, echo = FALSE, eval = FALSE}
...
datatable(populationVillesCanada, colnames = c('NouveauNom' = 'VariationPopulation'),
          options = list(pageLength = 5))
```
```{r colnames par substitution widgetframe, echo = FALSE, eval = FALSE}
...
datatable(populationVillesCanada, colnames = c('Col1', 'Col2', 'Col3', 'Col4'),
          options = list(pageLength = 5))
```
```{r colnames par vecteur de caractères widgetframe, echo = FALSE,  eval = FALSE}
...
datatable(data = populationVillesCanada, 
          ...
          options = list(pageLength = 5))
```
```{r cell-border widgetframe, echo = FALSE,  eval = FALSE}
...
datatable(data = populationVillesCanada, 
          ...
          options = list(pageLength = 5))
```
```{r compact widgetframe, echo = FALSE,  eval = FALSE}
...
datatable(populationVillesCanada, 
          ...
          options = list(pageLength = 5))
```
```{r caption widgetframe, echo = FALSE,  eval = FALSE}
...
datatable(populationVillesCanada, 
          ...
          options = list(pageLength = 5))
```
```{r caption et filter widgetframe, echo = FALSE,  eval = FALSE}
...
datatable(populationVillesCanada, 
          ...
          options = list(pageLength = 5))
```
```{r caption, filter et editable widgetframe, echo = FALSE,  eval = FALSE}
...
```
```{r language widgetframe, echo = FALSE,  eval = FALSE}
...
```
```{r order widgetframe, echo = FALSE,  eval = FALSE}
...
```
```{r formatStyle widgetframe, echo = FALSE,  eval = FALSE}
