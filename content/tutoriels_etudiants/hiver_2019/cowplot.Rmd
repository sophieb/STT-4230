...
Nous aurons besoin d'installer (si ce n'est pas déjà fait) et de charger le package `cowplot`. Le chargement de ce package provoque aussi le chargement du package `ggplot2`, dont il dépend.
