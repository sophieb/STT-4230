...
Hist <- gvisHistogram(datHist,options=list(width=1000, 
                                           legend="{position:'top'}",
...
Bubble <- gvisBubbleChart(seismes[c(50,100,150,200,250,300,350,400,450,500,550,600,650),],   
                          ...
                          options=list(vAxis="{title:'latitude',ticks:[-35,-30,-25,-20,-15]}",
                                       ...
                                       title="Graphique un bulles selon la longitude et la latitude par la profondeur, la 
                                       magnitude et le nombre de stations"))
plot(Bubble)
```
...
seismes$depth_affichage <- paste("Profondeur du tremblement de terre (en km) ",seismes$depth,sep=" : ")
