...
Lors de l'ouverture d'une session R, nous avons accès à un bon nombre de fonctions et de jeux de données. Les objets accessibles sont ceux contenus dans les packages R chargés automatiquement à l'ouverture de la session.
