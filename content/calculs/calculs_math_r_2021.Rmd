...
puis retirer les doublons du vecteur résultant avec la [fonction `unique`](https://stat.ethz.ch/R-manual/R-patched/library/base/html/unique.html) (que nous reverrons dans les [notes sur le prétraitement de données](https://stt4230.rbind.io/manipulation_donnees/pretraitement_donnees_r/#retrait-des-observations-dupliqu%C3%A9es)).
