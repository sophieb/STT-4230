...
- [mesure de dispersion](https://fr.wikipedia.org/wiki/Indicateur_de_dispersion)&nbsp;: [`sd`](https://stat.ethz.ch/R-manual/R-patched/library/stats/html/sd.html) (écart-type).
...
Voici un exemple de code R permettant de représenter graphiquement la densité $Bin(n = 5, p = 1/6)$ complète, en mettant en évidence la valeur calculée ci-dessus, soit $P(X = 2)$. *(Nous verrons dans les [notes sur les graphiques](https://stt4230.rbind.io/communication_resultats/graphiques_r/) comment produire ce genre de figure et les suivants.)*
...
dispersion | | [`sd`](https://stat.ethz.ch/R-manual/R-patched/library/stats/html/sd.html) | [`var`, `cov`, `cor`](https://stat.ethz.ch/R-manual/R-patched/library/stats/html/cor.html) | |
...
Documentation du package utilisé&nbsp;:
